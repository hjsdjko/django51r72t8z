...
import baokaozhiyuanList from '../pages/baokaozhiyuan/list'
import baokaozhiyuanDetail from '../pages/baokaozhiyuan/detail'
import baokaozhiyuanAdd from '../pages/baokaozhiyuan/add'
      ...
      redirect: '/index/home'
    },
		{
			...
			children:[
				...
				{
					path: 'baokaozhiyuan',
					component: baokaozhiyuanList
				},
				{
					path: 'baokaozhiyuanDetail',
					component: baokaozhiyuanDetail
				},
				{
					path: 'baokaozhiyuanAdd',
					component: baokaozhiyuanAdd
				},
				{
					path: 'newstype',
