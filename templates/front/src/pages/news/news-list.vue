...
<div>
	...
	<div class="news-preview-pv" :style='{"width":"1200px","margin":"10px auto","position":"relative","background":"none"}'>
		...
		<div class="news" :style='{"border":"1px solid #FE6917","flexWrap":"wrap","background":"none","borderWidth":"15px 0 0 ","display":"flex","width":"100%","height":"auto"}'>
		  ...
		  <div :style='{"padding":"20px 0","margin":"10px 0 0","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		    <div v-for="item in recommendList" :key="item.id" :style='{"width":"24%","padding":"10px","background":"#fff","height":"auto"}' @click="toNewsDetail(item)">
		      ...
		      <div :style='{"padding":"0 10px","lineHeight":"32px","fontSize":"16px","color":"#000000","textAlign":"center","fontWeight":"bold"}'>{{ item.title }}</div>
		      <div :style='{"padding":"0 10px","lineHeight":"12px","fontSize":"14px","color":"#000","textAlign":"center"}'>{{item.addtime}}</div>
		    </div>
		  </div>
		</div>
	</div>
