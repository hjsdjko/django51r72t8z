<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20240120/013cd1667f6c4da5b916657b405abeb4.png)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"360px 65% 100px 0","boxShadow":"none","margin":"0","flexDirection":"column","display":"flex","justifyContent":"center","overflow":"auto","borderRadius":"10px","background":"url(http://codegen.caihongy.cn/20240119/df513d605d3540b9a5097d15fe61b7f0.png)","width":"100vw","backgroundSize":"100% 100%","backgroundRepeat":"no-repeat","height":"100vh"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"margin":"0 0 20px 0","color":"#fff","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"32px","textShadow":"none"}'>基于 Python 的考研学习系统的设计与实现注册</p></div>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='xuesheng'" prop="xueshengzhanghao">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' :class="changeRules('xueshengzhanghao')?'required':''">学生账号：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='xuesheng'" prop="xueshengxingming">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' :class="changeRules('xueshengxingming')?'required':''">学生姓名：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='xuesheng'" prop="shoujihao">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' :class="changeRules('shoujihao')?'required':''">手机号：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='xuesheng'" prop="nianling">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' :class="changeRules('nianling')?'required':''">年龄：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='jiaoshi'" prop="jiaoshizhanghao">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' :class="changeRules('jiaoshizhanghao')?'required':''">教师账号：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='jiaoshi'" prop="jiaoshixingming">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' :class="changeRules('jiaoshixingming')?'required':''">教师姓名：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='jiaoshi'" prop="shoujihao">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' :class="changeRules('shoujihao')?'required':''">手机号：</div>
				<el-input v-model="registerForm.shoujihao"  placeholder="请输入手机号" />
			</el-form-item>
			...
			<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","boxShadow":"none","margin":"20px auto 5px","color":"#fff","display":"block","outline":"none","borderRadius":"5px","background":"#FE6917","width":"80%","fontSize":"20px","lineHeight":"50px","height":"50px"}' type="primary" @click="submitForm('registerForm')">注册</el-button>
			...
			<router-link :style='{"cursor":"pointer","padding":"0 10%","color":"#fff","textAlign":"center","display":"inline-block","lineHeight":"2","fontSize":"12px","textDecoration":"none"}' to="/login">已有账户登录</router-link>
          ...
          if (valid) {
            var url=this.tableName+"/register";
               ...
               if(`xuesheng` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
				...
				if((!this.registerForm.jiaoshizhanghao) && `jiaoshi` == this.tableName){
               ...
               if(`jiaoshi` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
				...
				if((!this.registerForm.mima) && `jiaoshi` == this.tableName){
					...
					if(`jiaoshi` == this.tableName && this.registerForm.shoujihao &&(!this.$validate.isMobile2(this.registerForm.shoujihao))){
						this.$message.error(`手机号应输入手机格式`);
						return
					}
